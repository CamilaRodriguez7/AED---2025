...
// entonces los array son diferentes
    ...
    public static void main(String[] args) {
        Integer nums[]={1,2,3,4,5}; // los unicos que son iguales son nums con nums2
...
// Crea un array de double
        ...
        if(igualArrays(nums,dvals)) // el error es por el tipo de dato que admite el metodo de clase igualArrays
